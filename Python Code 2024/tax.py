...
def main():
    ...
    elif income <= 191_1950:
        tax = 1160 + 4265.88 + 11_742.28 + (income - 100_525)*0.24
        bracket = '24% tax bracket'
        
    elif income <= 243_725:
        tax = 1160 + 4265.88 + 11_742.28 + 21_941.76 + (income - 191_151)*0.32
        bracket = '32% tax bracket'
        
    elif income <= 609_350:
        tax = 1160 + 4265.88 + 11_742.28 + 21_941.76 + (243_725 - 191_151)*0.32 + 0.35*(income - 243_725)
        bracket = '35% tax bracket'
    
    elif income <= 243_725:
        tax = 1160 + 4265.88 + 11_742.28 + 21_941.76 + (243_725 - 191_151)*0.32 + 0.35*(609_350 - 243_725) + 0.37*(income - 609_350)
